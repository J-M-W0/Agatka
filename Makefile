...
FILES += ./build/idt/idt.asm.o 
FILES += ./build/idt/idt.o 
FILES += ./build/memory/memory.o 
FILES += ./build/io/io.asm.o
FILES += ./build/memory/heap/heap.o
FILES += ./build/memory/heap/kheap.o
FILES += ./build/memory/paging/paging.o
FILES += ./build/memory/paging/paging.asm.o
FILES += ./build/disk/disk.o
FILES += ./build/string/string.o
FILES += ./build/fs/pparser.o
